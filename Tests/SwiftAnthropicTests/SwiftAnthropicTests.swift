...
final class SwiftAnthropicTests: XCTestCase {
    ...
    func testDecoding() throws {
        let swiftResponse = Response(id: "msg_01DjMHzuj6fP1jb5D2uWcqWz", content: "Hello! How can I assist you today? Feel free to ask me any questions or let me know if you need help with anything.", role: .assistant, model: .claude3_5Sonnet, stopReason: .endTurn, usage: Response.Usage(inputTokens: 9, outputTokens: 30))
        let recievedJSON = """
            {
